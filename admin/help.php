                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> Go to Dashboard > Add Product. You will have a familiar interface which can add products to the system
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>How to Add Users?</td>
                            <td>If you want to add a manufacturer, Go to Dashboard > Add Manufacturer. <br>If you want to add a retailer, Go to Dashboard > Add Retailer. 
                            </td>
                        </tr>
                    </tbody>
                </table>
